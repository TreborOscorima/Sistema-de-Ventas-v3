...
import { FileText, Users, DollarSign, AlertTriangle, Download, Search, Filter } from 'lucide-react';

export default function ReportesPage() {
  const { allCustomers, loading } = useCustomers();
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Cuentas por cobrar y análisis de deudas</p>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{formatCurrency(summary.avgDebt)}</div>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Deuda mayor a $2,000</p>
          </CardContent>
        </Card>
      </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <Select value={balanceFilter} onValueChange={setBalanceFilter}>
              ...
              <SelectContent>
                ...
                <SelectItem value="low">Bajo (≤ $500)</SelectItem>
                <SelectItem value="medium">Medio ($500 - $2,000)</SelectItem>
                <SelectItem value="high">Alto ({">"} $2,000)</SelectItem>
              </SelectContent>
            </Select>
